...
/* Actions */
import { listOrderDetails, updateOrder } from "../../actions/orderAction";
import { listClients } from "../../actions/clientAction";
import { listTables } from "../../actions/tableAction";

const orderEditViews = ({ history, match }) => {
